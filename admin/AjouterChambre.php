				...
				<div class = "col-md-4">	
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							...
							<select class = "form-control" required = required name = "TypeChambre">
						...
						<br />
						<div class = "form-group">
							<button name = "AjouterChambre" class = "btn btn-info form-control"><i class = "glyphicon glyphicon-save"></i> Sauvegarder</button>
						</div>
					</form>
					<?php require_once 'QueryAjouterChambre.php'?>
				</div>
			</div>
		</div>
	</div>

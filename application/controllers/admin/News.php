...
class News extends CI_Controller
{
	...
	function save()
	{
		...
		$this->session->set_flashdata('success','Offres enregistrées avec succès');
	...
	function update($id)
	{
		...
		$this->session->set_flashdata('success','offres mises à jour avec succès');
		redirect('admin/news/index');
	}
	...
	function delete($id)
	{
		...
		$this->session->set_flashdata('success','offre supprimé avec succès');
		redirect('admin/news/index');
	} 
